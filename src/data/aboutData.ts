...
export const aboutData = {
  ...
  highlights: [
    {
      ...
      description: "Building real-time data pipelines & analytics solutions",
    },
    {
      icon: Cloud,
      title: "Cloud Computing",
      description: "AWS, Oracle Cloud, Docker, Vercel & Render",
    },
    {
      icon: Code,
      title: "Backend Development",
      description: "Python, Flask, Spring, PHP",
    },
    {
      icon: Briefcase,
      title: "Currently",
      description: "Engineer student at ENSIBS (Data & Cybersecurity)",
    },
  ],
  location: {
    icon: MapPin,
  ...
  socialLinks: {
    ...
    email: "contact@houssamkarroum.com",
  },
};
